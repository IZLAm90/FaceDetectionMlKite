package com.lock.facerecognationml
...
class MainActivity : AppCompatActivity() , AdapterView.OnItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.button_run).setOnClickListener { runModelInference() }
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            runOnUiThread { findViewById<Button>(R.id.button_run).isEnabled = true }
        }
    }
